...
public class parseusers {
	...
	private static void writecontenttofile(String content, String name) throws IOException
	{
		...
		File file =new File("C:\\Users\\Arunima\\Desktop\\features\\Users\\"+name);
	...
	private static void process(String sCurrentLine, BufferedWriter bw) throws IOException {
		...
		{
			writecontenttofile(obj2.get("user_id").toString()+","+obj2.get("stars")+"\n",obj2.get("business_id")+".csv");
			writecontenttofile(obj2.get("user_id").toString()+"\n","all_restaurant_reviewers.csv");
		}
