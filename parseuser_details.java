...
public class parseuser_details {
	...
	private static void readandprocess() throws IOException
	{
		...
		try {
			...
			br = new BufferedReader(new FileReader("C:\\Users\\Arunima\\Desktop\\Yelp_Scripts\\yelp_phoenix_academic_dataset\\yelp_academic_dataset_user.json"));
	...
	private static void allrestaurantreviewersinhash() throws IOException
	{
		
		String file =("C:\\Users\\Arunima\\Desktop\\features\\Users\\all_restaurant_reviewers.csv");
	...
	private static void process(String sCurrentLine, BufferedWriter bw) throws IOException {
		...
		if(h.containsKey(obj2.get("user_id")))
		{
			
			writecontenttofile(obj2.get("user_id").toString()+","+obj2.get("review_count")+","+obj2.get("average_stars")+"\n","all_restaurant_reviewers_details.csv");
		}
